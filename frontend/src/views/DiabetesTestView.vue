  ...
  <div class="form-container">
    ...
    <div class="form-section">
      ...
      <div class="grid">
        ...
        <div class="field">
          <label>Días con 300+ min actividad</label>
          <InputNumber v-model="form.actividad_300min" :min="0" :max="7" class="w-full"/>
        </div>
        <div class="field">
          <label>Días de actividad muscular</label>
          <InputNumber v-model="form.actividad_muscular" :min="0" :max="7" class="w-full"/>
        </div>
        <div class="field">
...
const calcularBMI = () => {
  if (form.value.altura && form.value.peso) {
    ...
    return (form.value.peso / (alturaMetros * alturaMetros)).toFixed(2);
  }
  return null;
};
...
const raceOptions = [
  ...
  { label: 'Afroamericano', value: 2 },
  { label: 'Hispano', value: 3 },
  { label: 'Asiático', value: 4 },
  { label: 'Nativo Americano', value: 5 },
  { label: 'Otro', value: 6 }
];
